// ============================================================
// Template-variable resolution shared by the browser wizard
// (use-broadcast-sending) and the server-side scheduled-broadcast
// runner. Pure logic + one bulk fetch — no 'use client', no session
// assumptions; callers pass whichever Supabase client they hold.
// ============================================================
